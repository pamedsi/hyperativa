...
public class UserInfraRepository implements UserRepository {
    ...
    public User getUserByEmail(String email) {
        ...
        User user = userJPARepository.findByEmailAndDeletedFalse(email).orElseThrow(() -> new UserNotFoundException(email));
    ...
    public boolean existsByEmail(String email) {
        ...
        boolean exists = userJPARepository.existsByEmailAndDeletedFalse(email);
